...
class FreeplayDJ extends FlxAtlasSprite
{
  ...
  public function getCharData():PlayerFreeplayDJData{
    return playableCharData;
  }

  public function setCurrentState(state:FreeplayDJState = Idle) {
    currentState = state;
  }

  public function getCurrentState(state:FreeplayDJState = Idle):FreeplayDJState {
    return currentState;
  }
